class CommissioningReportStep3AutoFillResponse {
  final int status;
  final bool success;
  final CommissioningData data;
  final String message;

  CommissioningReportStep3AutoFillResponse({
  ...
  factory CommissioningReportStep3AutoFillResponse.fromJson(Map<String, dynamic> json) {
    return CommissioningReportStep3AutoFillResponse(
      status: json['status'],
