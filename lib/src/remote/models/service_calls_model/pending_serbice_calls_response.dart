...
class PendingServiceCallsResponse extends Equatable {
  final int status;
  final bool success;
  final PendingServiceCallsData data;
  final String message;

  const PendingServiceCallsResponse({
  ...
  factory PendingServiceCallsResponse.fromJson(Map<String, dynamic> json) {
    return PendingServiceCallsResponse(
      status: json['status'],
      success: json['success'],
      data: PendingServiceCallsData.fromJson(json['data']),
...
class PendingServiceCallsData extends Equatable {
  final List<ServiceCallResult> results;
  final Pagination pagination;

  const PendingServiceCallsData({
    required this.results,
    required this.pagination,
  });

  factory PendingServiceCallsData.fromJson(Map<String, dynamic> json) {
    return PendingServiceCallsData(
...
class ServiceCallResult extends Equatable {
  ...
  final String status; // "pending" in this case
