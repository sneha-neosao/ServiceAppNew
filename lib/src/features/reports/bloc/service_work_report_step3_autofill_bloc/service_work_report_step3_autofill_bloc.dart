...
class ServiceWorkReportStep3AutofillBloc extends Bloc<
    ServiceWorkReportStep3AutofillEvent, ServiceWorkReportStep3AutofillState> {
  ...
  ServiceWorkReportStep3AutofillBloc(this.usecase)
    ...
    on<GetServiceWorkReportStep3AutofillEvent>((event, emit) async {
      ...
      result.fold(
        (failure) => emit(ServiceWorkReportStep3AutofillFailure(failure.message)),
