...
class DeleteServiceWorkReportUsecase
    implements UseCase<DeleteServiceWorkReportResponse, String> {
  final AuthRepositoryImpl repository;

  DeleteServiceWorkReportUsecase(this.repository);

  @override
  Future<Either<Failure, DeleteServiceWorkReportResponse>> call(
    String reportId,
  ) async {
