...
class AssignedTechnicianRepresentativeBloc extends Bloc<AssignedTechnicianRepresentativeEvent, AssignedTechnicianRepresentativeState> {
  final AssignedTechnicianRepresentativeUsecase usecase;

  AssignedTechnicianRepresentativeBloc(this.usecase) : super(AssignedTechnicianRepresentativeInitialState()) {
    on<AssignedTechnicianRepresentativeGetEvent>((event, emit) async {
      emit(AssignedTechnicianRepresentativeLoadingState());

      final result = await usecase(AssignedTechnicianRepresentativeParams(
