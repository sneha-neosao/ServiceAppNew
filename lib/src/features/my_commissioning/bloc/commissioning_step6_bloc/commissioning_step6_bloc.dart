...
class CommissioningStep6Bloc extends Bloc<CommissioningStep6Event, CommissioningStep6State> {
  final CommissioningStep6Usecase usecase;

  CommissioningStep6Bloc(this.usecase) : super(CommissioningStep6InitialState()) {
    on<CommissioningStep6SubmitEvent>((event, emit) async {
      emit(CommissioningStep6LoadingState());

      final result = await usecase(CommissioningStep6Params(
