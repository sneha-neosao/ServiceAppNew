...
class CommissioningStep5AutoFillBloc extends Bloc<CommissioningStep5AutoFillEvent, CommissioningStep5AutoFillState> {
  final CommissioningStep5AutofillUsecase usecase;

  CommissioningStep5AutoFillBloc(this.usecase) : super(CommissioningStep5AutoFillInitialState()) {
    on<CommissioningStep5AutoFillGetEvent>((event, emit) async {
      emit(CommissioningStep5AutoFillLoadingState());

      final result = await usecase(CommissioningStep5AutofillParams(
