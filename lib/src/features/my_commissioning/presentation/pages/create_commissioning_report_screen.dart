...
class CreateCommissioningReportScreen extends StatefulWidget {
  ...
  @override
  State<CreateCommissioningReportScreen> createState() => _CreateCommissioningReportScreenState();
}

class _CreateCommissioningReportScreenState extends State<CreateCommissioningReportScreen> {
  int _currentStep = 1;
  ...
  void initState() {
    super.initState();
    _technicians = widget.isServiceReport ? ['Pravin Patil'] : ['Vinod Patil', 'Prashant Shinde'];
  }
  ...
  String _getStepInfo() {
    switch (_currentStep) {
      case 1: return 'create_report_step_info'.tr();
      case 2: return 'create_report_step_info_2'.tr();
      case 3: return 'create_report_step_info_3'.tr();
      case 4: return 'create_report_step_info_4'.tr();
      case 5: return 'create_report_step_info_5'.tr();
      case 6: return 'create_report_step_info_6'.tr();
      default: return 'STEP $_currentStep OF 6';
    }
  }
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          widget.isServiceReport ? 'Service Report' : 'Commissioning Report',
                          style: AppFont.style(fontSize: 22, fontWeight: FontWeight.w900, color: const Color(0xFF0D121F)),
                        ),
                        Text(
                          _getStepInfo(),
  ...
  Widget _buildStep1() {
    return Column(
      ...
      children: [
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.business_outlined, color: Color(0xFFA5ABB7), size: 32),
              ),
        ...
        _buildLabel('create_report_service_provider'.tr()),
        ...
        Row(
          ...
          children: [
            _buildLabel('create_report_tech_name'.tr() + '(s)'),
            GestureDetector(
              onTap: () {
                // Add technician logic
              },
              child: Text(
                'create_report_add_plus'.tr(),
                style: AppFont.style(
                  fontSize: 14,
                  fontWeight: FontWeight.w900,
                  color: const Color(0xFF1565C0),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            _technicians.remove(name);
                          });
                        },
                        child: const Icon(Icons.remove, color: Color(0xFFFF5252), size: 24),
                      ),
                    ],
                  ),
                  const SizedBox(height: 12),
        ...
        _buildInfoRow('create_report_customer_name'.tr(), 'Global Infotech'),
        const SizedBox(height: 24),
        _buildInfoRow('create_report_site_name'.tr(), 'Main Server Room'),
        const SizedBox(height: 24),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Icon(Icons.mic_none, color: Color(0xFFA5ABB7), size: 20),
  ...
  Widget _buildStep4() {
    return Column(
      ...
      children: [
        ...
        ...List.generate(_workDescriptionRows, (index) => _buildWorkDescriptionField(index + 1)),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(8),
            border: Border.all(color: const Color(0xFFF1F2F6)), // Should be dashed if possible
          ),
          child: Column(
  ...
  Widget _buildPlaceholderStep(String title) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: AppFont.style(fontSize: 18, fontWeight: FontWeight.w900, color: const Color(0xFF0D121F))),
        const SizedBox(height: 20),
        const Center(child: Icon(Icons.construction, size: 100, color: Color(0xFFF1F2F6))),
      ],
    );
  }

  Widget _buildLabel(String text) {
    return Text(text, style: AppFont.style(fontSize: 12, fontWeight: FontWeight.w800, color: const Color(0xFFA5ABB7)));
  }

  Widget _buildAddNewButton(String text) {
    return GestureDetector(
      onTap: () {},
      child: Text(text, style: AppFont.style(fontSize: 12, fontWeight: FontWeight.w800, color: const Color(0xFF1565C0))),
    );
  }
  ...
  Widget _buildDropdownField(String hint) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(hint, style: AppFont.style(fontSize: 14, fontWeight: FontWeight.w800, color: const Color(0xFFA5ABB7))),
