...
class CommissioningStep5AutofillUsecase
    implements
        UseCase<
          CommissioningReportStep5AutoFillResponse,
          CommissioningStep5AutofillParams
        > {
  ...
  Future<Either<Failure, CommissioningReportStep5AutoFillResponse>> call(
    CommissioningStep5AutofillParams params,
  ) async {
...
class CommissioningStep5AutofillParams extends Equatable {
  ...
  const CommissioningStep5AutofillParams(this.id);
