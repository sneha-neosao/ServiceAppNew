...
class CommissioningStep2AutofillUsecase implements UseCase<CommissioningReportStep2AutoFillResponse, CommissioningStep2AutofillParams> {

  final Repository _authRepository;
  const CommissioningStep2AutofillUsecase(this._authRepository);

  @override
  Future<Either<Failure, CommissioningReportStep2AutoFillResponse>> call(CommissioningStep2AutofillParams params) async {

    final result = await _authRepository.commissioning_report_step2_autofill(params);
