...
class CommissioningStep4AutofillUsecase
    implements
        UseCase<
          CommissioningReportStep4AutoFillResponse,
          CommissioningStep4AutofillParams
        > {
  ...
  Future<Either<Failure, CommissioningReportStep4AutoFillResponse>> call(
    CommissioningStep4AutofillParams params,
  ) async {
...
class CommissioningStep4AutofillParams extends Equatable {
  ...
  const CommissioningStep4AutofillParams(this.id);
