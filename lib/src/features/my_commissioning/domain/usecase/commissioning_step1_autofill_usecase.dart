...
class CommissioningStep1AutofillUsecase implements UseCase<CommissioningReportStep1AutoFillResponse, CommissioningStep1AutofillParams> {

  final Repository _authRepository;
  const CommissioningStep1AutofillUsecase(this._authRepository);

  @override
  Future<Either<Failure, CommissioningReportStep1AutoFillResponse>> call(CommissioningStep1AutofillParams params) async {

    final result = await _authRepository.commissioning_report_step1_autofill(params);
