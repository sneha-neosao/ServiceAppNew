...
class CommissioningStep5Usecase implements UseCase<CommissioningReportStep5AutoFillResponse, CommissioningStep5Params> {
  final Repository _authRepository;

  const CommissioningStep5Usecase(this._authRepository);

  @override
  Future<Either<Failure, CommissioningReportStep5AutoFillResponse>> call(CommissioningStep5Params params) async {
