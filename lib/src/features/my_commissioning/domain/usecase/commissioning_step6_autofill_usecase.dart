...
class CommissioningStep6AutofillUsecase implements UseCase<CommissioningReportStep6AutoFillResponse, CommissioningStep6AutofillParams> {
  final Repository _authRepository;

  const CommissioningStep6AutofillUsecase(this._authRepository);

  @override
  Future<Either<Failure, CommissioningReportStep6AutoFillResponse>> call(CommissioningStep6AutofillParams params) async {
...
class CommissioningStep6AutofillParams extends Equatable {
  ...
  const CommissioningStep6AutofillParams(
    this.id,
  );
