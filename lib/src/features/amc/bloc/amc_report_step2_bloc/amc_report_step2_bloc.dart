...
class AmcReportStep2Bloc
    extends Bloc<AmcReportStep2Event, AmcReportStep2State> {
  final PostAmcReportStep2Usecase postAmcReportStep2Usecase;

  AmcReportStep2Bloc(this.postAmcReportStep2Usecase)
    : super(AmcReportStep2InitialState()) {
