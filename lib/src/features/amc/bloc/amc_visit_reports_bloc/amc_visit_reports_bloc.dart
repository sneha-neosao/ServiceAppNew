...
class AmcVisitReportsBloc extends Bloc<AmcVisitReportsEvent, AmcVisitReportsState> {
  final AmcVisitReportsUsecase amcVisitReportsUsecase;

  AmcVisitReportsBloc(this.amcVisitReportsUsecase) : super(AmcVisitReportsInitialState()) {
  ...
  Future<void> _onGetAmcVisitReports(
    ...
    result.fold(
      (failure) => emit(AmcVisitReportsFailureState(errorMessage: failure.message)),
