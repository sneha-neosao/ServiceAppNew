...
class PendingServiceCallsBloc
    extends Bloc<PendingServiceCallsEvent, PendingServiceCallsState> {
  ...
  PendingServiceCallsBloc(this._useCase)
    : super(PendingServiceCallsInitialState()) {
