...
class ServiceCallReportStep6AutoFillBloc
    extends
        Bloc<
          ServiceCallReportStep6AutoFillEvent,
          ServiceCallReportStep6AutoFillState
        > {
  final ServiceCallReportStep6AutoFillUsecase usecase;

  ServiceCallReportStep6AutoFillBloc(this.usecase)
    : super(ServiceCallReportStep6AutoFillInitialState()) {
