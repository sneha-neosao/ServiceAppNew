...
class ServiceCallReportStep6AutoFillUsecase implements UseCase<ServiceCallReportStep6AutoFillResponse, String> {
  final Repository _authRepository;

  const ServiceCallReportStep6AutoFillUsecase(this._authRepository);

  @override
  Future<Either<Failure, ServiceCallReportStep6AutoFillResponse>> call(String reportId) async {
