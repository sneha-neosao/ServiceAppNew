...
class AppGreenButtonWidget extends StatefulWidget {
  ...
  const AppGreenButtonWidget({super.key, required this.onPressed, required this.label});
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: ElevatedButton(
          ...
          child: Text(
            widget.label,
            style: Theme.of(context).textTheme.headlineMedium!.copyWith(color: AppColor.white,fontSize: 17),
